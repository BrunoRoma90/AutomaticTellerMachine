...
namespace FinalProjectAtm.Razor.Pages.Transactions
{
    public class WithdrawalModel : PageModel
    {
        ...
        public WithdrawalModel(IMemoryCache memoryCache) => _memoryCache = memoryCache;
        ...
        private IWithdrawalTransactionServices _withdrawalTransaction = new WithdrawalTransactionServices();
        ...
        public IActionResult OnPost(double amount)
        {
            ...
            bool withdrawalSuccessful = _withdrawalTransaction.Withdrawal(Account.Id, amount);
